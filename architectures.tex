\subsection{Configuration of testbeds used for benchmerking}
...
Xeon\textregistered Gold 6140 \cite{INTELXEONGOLD6140} from Intel,
AMD Epyc\textsuperscript{TM} 7551 from AMD,
Hi1616 from ARM, and
Power8 from IBM.
While
...
\multicolumn{1}{|l|}{\textbf{L1 (data) cache}} &  &  &  & 2803 \\ \hline
\multicolumn{1}{|l|}{\textbf{L2 cache}} &  &  &  & 2803 \\ \hline
\multicolumn{1}{|l|}{\textbf{L3}} &  &  &  & 3738 \\ \hline
\multicolumn{1}{|l|}{\textbf{Total memory}} &  &  &  & 230 \\ \hline
...
Being designed for ``accelerated workloads in high-performance computing (HPC), high-performance data analytics (HPDA), enterprise data centers, and accelerated cloud deployments'' \cite{2015:power8,2016:power8}, IBM 8335 Power System S822LC for High Performance Computing server Model GTB (8335-GTB) perfectly suitsfor all kinds of GSS applications. % including preprocessing (e.g., creating synthetic populations and synthetic networks), simulation, HPDA, and visualization.
S822LC brings together two POWER8 CPUs with four NVIDIA Tesla P100 GPUs through NVLink Technology.
